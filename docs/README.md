...
| [design/decision-models.md](design/decision-models.md) | 决策模型接入 (2026-09-22): jev / laya 这类 typed decision 模型接成整句重排的第二打分来源, 相对分的算法, 协议与隐私边界 |
| [design/phrase-learning.md](design/phrase-learning.md) | 记词组: 选中文字 + 拼音记成用户词 (为什么记成用户词而不进自定义短语, 评审态为什么不碰应用内容, 读音反查与记账) |
